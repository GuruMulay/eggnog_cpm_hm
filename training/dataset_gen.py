...
class DataGenerator(object):
    ...
    def __init__(self, data_path, height = 240, width = 320, n_channels = 3, batch_size = 5, shuffle = True,
        ...
        self.hm_only_network = hm_only_network
    ...
    def generate(self, file_IDs, n_stages):
        ...
        while 1:
            ...
            for i in range(imax):
                ...
                if self.hm_only_network:
                    # Generate data
                    X, y2 = self.__data_generation_hm_network(file_IDs_temp)
                    yield [X], [y2] * n_stages
    ...
    def __data_generation_hm_network(self, file_IDs_temp):
