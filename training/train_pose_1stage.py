...
from model import get_training_model_eggnog, get_training_model_eggnog_new
...
verbose_print = True
only_hm = True  # heatmap only netwrok architecture
...
lr_policy = "step"
gamma = 0.333
stepsize = 100000*10 # in original code each epoch is 121746 and step change is on 17th epoch
max_iter = 300
...
model = get_training_model_eggnog_new(weight_decay, gpus=use_multiple_gpus, stages=n_stages, only_hm=only_hm)
...
if wfile is not None:
    ...
    cpm_weights_path = "/s/parsons/h/proj/vision/usr/guru5/repos_cpm/keras-openpose-reproduce/model/keras/model.h5"  # original weights converted from caffe
